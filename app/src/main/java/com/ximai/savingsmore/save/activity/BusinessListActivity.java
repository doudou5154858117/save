...
public class BusinessListActivity extends BaseActivity {
    ...
    private void getBUsinessList(String keyWord) {
        WebRequestHelper.json_post(BusinessListActivity.this, URLText.BUSINESS_LIST, RequestParamsPool.businessList(keyWord), new MyAsyncHttpResponseHandler(BusinessListActivity.this) {
            @Override
