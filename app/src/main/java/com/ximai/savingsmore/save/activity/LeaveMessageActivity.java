...
public class LeaveMessageActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void leave_message() {
        WebRequestHelper.json_post(LeaveMessageActivity.this, URLText.SAVE_MESSAGE, RequestParamsPool.sendMessage(id, t_name, t_city, t_phone, t_email, t_qq, t_content), new MyAsyncHttpResponseHandler(LeaveMessageActivity.this) {
            @Override
